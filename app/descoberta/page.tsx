    ...
    <div className="mx-auto flex max-w-3xl flex-col gap-5">
      <div>
        ...
        <p className="text-sm text-slate-500">
          ...
          (Apify), importe os perfis promissores e extraia contatos dos sites. Nada aqui usa a
          sua conta do Instagram — o Apify roda na infraestrutura deles.
        </p>
      </div>
      ...
      <form action={acaoGarimpo} className="card flex flex-col gap-4">
        ...
        <div className="grid gap-3 sm:grid-cols-[1fr_140px]">
          <div>
            ...
            <input type="text" id="hashtags" name="hashtags" placeholder="publi, trekkingbrasil" required />
          </div>
          <div>
